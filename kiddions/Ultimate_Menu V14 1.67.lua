...
TunMenu:add_float_range("AP", 1, 1, 100000, function() return globals.get_float(288060) end, function(v) globals.set_float(288060, v) end)
TunMenu:add_float_range("Street Races", 1, 1, 100000, function() return globals.get_float(293783) end, function(v) globals.set_float(293783, v) end)
TunMenu:add_float_range("Pursuits", 1, 1, 100000, function() return globals.get_float(293784) end, function(v) globals.set_float(293784, v) end)
TunMenu:add_float_range("Face2Face", 1, 1, 100000, function() return globals.get_float(293786) end, function(v) globals.set_float(293786, v) end)
TunMenu:add_float_range("LS Car Meet", 1, 1, 100000, function() return globals.get_float(293787) end, function(v) globals.set_float(293787, v) end)
TunMenu:add_float_range("LS Car Meet on track", 1, 1, 100000, function() return globals.get_float(293788) end, function(v) globals.set_float(293788, v) end) local awa = 0 local awc = 0 local awr = 0
TunMenu:add_int_range("AP Arena Wars", 5000, 0, 500000, function() return awa end, function(v) for i = 286232, 286234 do globals.set_int(i, v) end for j = 286241, 286243 do globals.set_int(j, v) end awa = v end)
...
L7NEG3:add_action("Unlock Gun Van RailGun", function()
...
L7NEG3:add_toggle("Enable Deleted Vehicles", function() return globals.get_int(262145+35167) end, function(value) local startNum = 35167 local endNum = 20394 for i = startNum, endNum, 2 do globals.set_int(262145 + i, 1) end end)
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	ColTMenu:add_action("Movie Props", function() globals.set_int(262145 + 29879 , 10) end)
	ColTMenu:add_action("Signal Jammers", function() globals.set_int(262145 + 28581 , 50) end)
        ColTMenu:add_action("LD Organics", function() globals.set_int(262145 + 32993 , 100) end)
        ColTMenu:add_action("Buried Stashs", function() globals.set_int(262145 + 31158 , 10) end)
        ColTMenu:add_action("Jack o Lantern", function() globals.set_int(262145 + 32978 , 10) end)
        ColTMenu:add_action("Treasure Chests", function() globals.set_int(262145 + 29947 , 30) end)
	
	ColPMenu = ColMenu:add_submenu("Unlock All (Permanently)")
	
	ColPMenu:add_action("Movie Props", function() globals.set_int(262145 + 29879 , 9) end)
	ColPMenu:add_action("Signal Jammers", function() globals.set_int(262145 + 28581 , 49) end)
        ColPMenu:add_action("LD Organics", function() globals.set_int(262145 + 32993 , 99) end)
        ColPMenu:add_action("Buried Stashs", function() globals.set_int(262145 + 31158 , 9) end)
        ColPMenu:add_action("Jack o Lantern", function() globals.set_int(262145 + 32978 , 9) end)
	ColPMenu:add_action("Treasure Chests", function() globals.set_int(262145 + 29947 , 29) end)
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	CSNote:add_action("                Unlock «Change Gender»:", function() end)
	CSNote:add_action("     Unlocks «Change Gender» option while", function() end)
...
L7NEG1:add_action("---Discord:@eaztea/TeaTimeTea---", function() end)
