...
L7NEG = menu.add_submenu("\u{1F53B}" .. " Ultimate Menu 1.70 By L7NEG " .. "\u{1F53B}")
...
Self:add_array_item("Online Session", {
	...
	xox_0 = value
	if value == 1 then
		globals.set_int(1575036, 0)
		globals.set_int(1574589, 1)
		sleep(0.2)
		globals.set_int(1574589, 0)
	elseif value == 2 then
		globals.set_int(1575036, 1)
		globals.set_int(1574589, 1)
		sleep(0.2)
		globals.set_int(1574589, 0)
	elseif value == 3 then
		...
		globals.set_int(1574589, 0)
	elseif value == 4 then
		globals.set_int(1575036, 2)
		globals.set_int(1574589, 1)
		sleep(0.2)
		globals.set_int(1574589, 0)
	elseif value == 5 then
		globals.set_int(1575036, 3)
		globals.set_int(1574589, 1)
		sleep(0.2)
		globals.set_int(1574589, 0)
	elseif value == 6 then
		globals.set_int(1575036, 6)
		globals.set_int(1574589, 1)
		sleep(0.2)
		globals.set_int(1574589, 0)
	elseif value == 7 then
		globals.set_int(1575036, 9)
		globals.set_int(1574589, 1)
		sleep(0.2)
		globals.set_int(1574589, 0)
	elseif value == 8 then
		globals.set_int(1575036, 8)
		globals.set_int(1574589, 1)
		sleep(0.2)
		globals.set_int(1574589, 0)
	elseif value == 9 then
...
Self:add_action("Equip Ballistic Equipment Directly", function()
	globals.set_int(REQS1 + 928, 1)
end)
...
Self:add_action("Refill Nightclub Popularity", function()
...
Config.VehicleSpawnGlobal = 2640052
Config.TrickOrTreatBase = 2640052
...
local function createVehicle(modelhash, pos)
	globals.set_int(Config.VehicleSpawnGlobal + 50, modelhash)
	globals.set_float(Config.VehicleSpawnGlobal + 46, pos.x)
	globals.set_float(Config.VehicleSpawnGlobal + 47, pos.y)
	globals.set_float(Config.VehicleSpawnGlobal + 48, pos.z)
	globals.set_boolean(Config.VehicleSpawnGlobal + 45, true)
end
...
normalstat:add_int_range("Deaths per player", 10, 0, 999999, function()
...
distancestat:add_float_range("Swimming", 10.00, 0.00, 99999.00, function()
...
distancestat:add_float_range("Longest Front Wheelie", 10.00, 0.00, 99999.00, function()
	return stats.get_float(MPX .. "LONGEST_STOPPIE_DIST") / 1000
end, function(value)
	stats.set_float(MPX .. "LONGEST_STOPPIE_DIST", value * 1000)
end)
distancestat:add_float_range("Longest Wheelie", 10.00, 0.00, 99999.00, function()
	return stats.get_float(MPX .. "LONGEST_WHEELIE_DIST") / 1000
end, function(value)
	stats.set_float(MPX .. "LONGEST_WHEELIE_DIST", value * 1000)
end)
distancestat:add_float_range("Longest drive without crashing", 10.00, 0.00, 99999.00, function()
...
distancestat:add_float_range("Highest Hydraulic Jump", 10.00, 0.00, 99999.00, function()
...
timestat:add_int_range("Average Time in session", 1, 0, 24, function()
...
timestat:add_int_range("Time swimming", 1, 0, 24, function()
...
timestat:add_int_range("Driving Boats", 1, 0, 24, function()
...
FAUT:add_action("Complete All Daily & Weekly Challenges", function()
...
MoneyRemoveRecoveryMenu:add_int_range("Set Ballistic Value", 1000000, 1000000, 2147483647, function()
...
MoneyRemoveRecoveryMenu:add_action("Remove Casino Chips Cooldown", function()
...
CashRemover:add_bare_item("", function()
	...
	globals.set_int(262145 + 23969, CashToRemove)
	sleep(1)
	DefNum1Cur = 1
	DefNum2Cur = 1
	DefNum3Cur = 1
...
VehiclesMenu:add_array_item("Request Services", {
	...
	if v == 1 then
		globals.set_int(REQS1 + 956, 1)
	elseif v == 2 then
		globals.set_int(REQS1 + 964, 1)
	elseif v == 3 then
		globals.set_int(REQS1 + 969, 1)
	elseif v == 4 then
		globals.set_int(REQS1 + 991, 1)
	elseif v == 5 then
		globals.set_int(REQS1 + 1003, 1)
	elseif v == 6 then
		globals.set_int(REQS1 + 970, 1)
	elseif v == 7 then
		globals.set_int(REQS1 + 1025, 1)
	elseif v == 8 then
		globals.set_int(REQS1 + 927, 1)
	else
...
function SpawnVehicle(Hash)
	...
	globals.set_int(2640052 + 50, Hash)
	globals.set_float(2640052 + 46, pos.x)
	globals.set_float(2640052 + 47, pos.y)
	globals.set_float(2640052 + 48, pos.z)
	globals.set_boolean(2640052 + 45, true)
	sleep(0.5)
...
local repaiRecoveryMenu = funcmenu:add_submenu("Revive And Destroy Menu")
...
ApartmentNormalCutsEditorMenu:add_int_range("Self Cut (Non-Host)", 1, 0, 1000, function()
	return globals.get_int(2685658 + 6651)
end, function(value)
	globals.set_int(2685658 + 6651, value)
end)
...
CasinoHeistMenu:add_int_range("Casino Player1 Cut", 5.0, 15, 100, function()
	return globals.get_int(1965614 + 1497 + 736 + 92 + 1)
end, function(value)
	globals.set_int(1965614 + 1497 + 736 + 92 + 1, value)
	H3C1 = p1
end)

CasinoHeistMenu:add_int_range("Casino Player2 Cut", 5.0, 15, 100, function()
	return globals.get_int(1965614 + 1497 + 736 + 92 + 1 + 1)
end, function(value)
	globals.set_int(1965614 + 1497 + 736 + 92 + 1 + 1, value)
	H3C2 = p2
end)

CasinoHeistMenu:add_int_range("Casino Player3 Cut", 5.0, 15, 100, function()
	return globals.get_int(1965614 + 1497 + 736 + 92 + 1 + 1 + 1)
end, function(value)
	globals.set_int(1965614 + 1497 + 736 + 92 + 1 + 1 + 1, value)
	H3C3 = p3
end)

CasinoHeistMenu:add_int_range("Casino Player4 Cut", 5.0, 15, 100, function()
	return globals.get_int(1965614 + 1497 + 736 + 92 + 1 + 1 + 1 + 1)
end, function(value)
	globals.set_int(1965614 + 1497 + 736 + 92 + 1 + 1 + 1 + 1, value)
	H3C4 = p4
end)
...
CasinoHeistMenu:add_int_range("Casino Lifes - Self", 1, 1, 999999999, function()
	return FMC:get_int(26207 + 1325 + 1)
end, function(life)
	if FMC and FMC:is_active() then
		FMC:set_int(26207 + 1325 + 1, life)
	end
end)
...
CayoPericoHeistMenu:add_action("Instant Finish $$", function()
	FMC2020:set_int(52171, 9)
	FMC2020:set_int(52171 + 1776 + 1, 50)
end)
...
cutsMenu:add_array_item(
	...
	function(G)
		if G == 1 then
			for i = 1972414 + 831 + 56 + 1, 1972414 + 831 + 56 + 4 do
...
cutsMenu:add_int_range("Player 1", 1, 15, 300, function()
	return globals.get_int(1972414 + 831 + 56 + 1)
end, function(value)
	globals.set_int(1972414 + 831 + 56 + 1, value)
end)
cutsMenu:add_int_range("Player 2", 1, 15, 300, function()
	return globals.get_int(1972414 + 831 + 56 + 2)
end, function(value)
	globals.set_int(1972414 + 831 + 56 + 2, value)
end)
cutsMenu:add_int_range("Player 3", 1, 15, 300, function()
	return globals.get_int(1972414 + 831 + 56 + 3)
end, function(value)
	globals.set_int(1972414 + 831 + 56 + 3, value)
end)
cutsMenu:add_int_range("Player 4", 1, 15, 300, function()
	return globals.get_int(1972414 + 831 + 56 + 4)
end, function(value)
	globals.set_int(1972414 + 831 + 56 + 4, value)
end)
...
UpdateUnlockeRecoveryMenu:add_action("Unlock Police Cars Trade Price", function()
...
UpdateUnlockeRecoveryMenu:add_action("Fix Salvage Heist", function()
...
function toggleDV()
	...
	globals.set_boolean(262145 + 25366, isEnabled)
	globals.set_boolean(262145 + 25367, isEnabled)
	globals.set_boolean(262145 + 25368, isEnabled)
	globals.set_boolean(262145 + 25369, isEnabled)
	globals.set_boolean(262145 + 25370, isEnabled)
	globals.set_boolean(262145 + 25371, isEnabled)
	globals.set_boolean(262145 + 25372, isEnabled)
	globals.set_boolean(262145 + 25377, isEnabled)
	globals.set_boolean(262145 + 25378, isEnabled)
	globals.set_boolean(262145 + 25379, isEnabled)
	globals.set_boolean(262145 + 25380, isEnabled)
	globals.set_boolean(262145 + 25381, isEnabled)
	globals.set_boolean(262145 + 25382, isEnabled)
	...
	globals.set_boolean(262145 + 25388, isEnabled)
	globals.set_boolean(262145 + 25389, isEnabled)
	globals.set_boolean(262145 + 25390, isEnabled)
	globals.set_boolean(262145 + 25391, isEnabled)
	globals.set_boolean(262145 + 25392, isEnabled)
	globals.set_boolean(262145 + 25393, isEnabled)
	globals.set_boolean(262145 + 25394, isEnabled)
	globals.set_boolean(262145 + 25395, isEnabled)
	globals.set_boolean(262145 + 25396, isEnabled)
	globals.set_boolean(262145 + 25397, isEnabled)
	globals.set_boolean(262145 + 26329, isEnabled)
	globals.set_boolean(262145 + 26330, isEnabled)
	globals.set_boolean(262145 + 32412, isEnabled)
	globals.set_boolean(262145 + 32413, isEnabled)
	globals.set_boolean(262145 + 32414, isEnabled)
	globals.set_boolean(262145 + 32415, isEnabled)
	globals.set_boolean(262145 + 32416, isEnabled)
	globals.set_boolean(262145 + 32417, isEnabled)
	globals.set_boolean(262145 + 32418, isEnabled)
	globals.set_boolean(262145 + 32419, isEnabled)
	globals.set_boolean(262145 + 32420, isEnabled)
	globals.set_boolean(262145 + 32421, isEnabled)
	globals.set_boolean(262145 + 32422, isEnabled)
	globals.set_boolean(262145 + 32423, isEnabled)
	globals.set_boolean(262145 + 32424, isEnabled)
	globals.set_boolean(262145 + 32425, isEnabled)
	globals.set_boolean(262145 + 32426, isEnabled)
	globals.set_boolean(262145 + 32427, isEnabled)
	globals.set_boolean(262145 + 32428, isEnabled)
	globals.set_boolean(262145 + 32429, isEnabled)
	globals.set_boolean(262145 + 32430, isEnabled)
	globals.set_boolean(262145 + 33374, isEnabled)
	globals.set_boolean(262145 + 33375, isEnabled)
	globals.set_boolean(262145 + 33376, isEnabled)
	globals.set_boolean(262145 + 33377, isEnabled)
	globals.set_boolean(262145 + 33378, isEnabled)
	globals.set_boolean(262145 + 33379, isEnabled)
	globals.set_boolean(262145 + 33380, isEnabled)
	globals.set_boolean(262145 + 33381, isEnabled)
	globals.set_boolean(262145 + 33382, isEnabled)
	globals.set_boolean(262145 + 33383, isEnabled)
	globals.set_boolean(262145 + 33384, isEnabled)
	globals.set_boolean(262145 + 33385, isEnabled)
	globals.set_boolean(262145 + 33386, isEnabled)
	globals.set_boolean(262145 + 33387, isEnabled)
	globals.set_boolean(262145 + 33388, isEnabled)
	globals.set_boolean(262145 + 33389, isEnabled)
	globals.set_boolean(262145 + 35172, isEnabled)
	globals.set_boolean(262145 + 35173, isEnabled)
	globals.set_boolean(262145 + 35174, isEnabled)
	globals.set_boolean(262145 + 35175, isEnabled)
	globals.set_boolean(262145 + 35176, isEnabled)
	globals.set_boolean(262145 + 35177, isEnabled)
	globals.set_boolean(262145 + 35178, isEnabled)
	globals.set_boolean(262145 + 35179, isEnabled)
	globals.set_boolean(262145 + 35180, isEnabled)
	globals.set_boolean(262145 + 35181, isEnabled)
	globals.set_boolean(262145 + 35182, isEnabled)
	globals.set_boolean(262145 + 35183, isEnabled)
	globals.set_boolean(262145 + 35184, isEnabled)
	globals.set_boolean(262145 + 35185, isEnabled)
	globals.set_boolean(262145 + 35186, isEnabled)
	globals.set_boolean(262145 + 35187, isEnabled)
	globals.set_boolean(262145 + 35188, isEnabled)
	globals.set_boolean(262145 + 35189, isEnabled)
	globals.set_boolean(262145 + 35190, isEnabled)
	globals.set_boolean(262145 + 35191, isEnabled)
	globals.set_boolean(262145 + 35405, isEnabled)
	globals.set_boolean(262145 + 28169, isEnabled)
	globals.set_boolean(262145 + 28170, isEnabled)
	globals.set_boolean(262145 + 28171, isEnabled)
	globals.set_boolean(262145 + 28172, isEnabled)
	globals.set_boolean(262145 + 28173, isEnabled)
	globals.set_boolean(262145 + 28174, isEnabled)
	globals.set_boolean(262145 + 28175, isEnabled)
	globals.set_boolean(262145 + 28176, isEnabled)
	globals.set_boolean(262145 + 28177, isEnabled)
	globals.set_boolean(262145 + 28178, isEnabled)
	globals.set_boolean(262145 + 28179, isEnabled)
	globals.set_boolean(262145 + 28180, isEnabled)
	globals.set_boolean(262145 + 28181, isEnabled)
	globals.set_boolean(262145 + 28182, isEnabled)
	globals.set_boolean(262145 + 28183, isEnabled)
	globals.set_boolean(262145 + 28184, isEnabled)
	globals.set_boolean(262145 + 28185, isEnabled)
	globals.set_boolean(262145 + 28186, isEnabled)
	globals.set_boolean(262145 + 28187, isEnabled)
	globals.set_boolean(262145 + 28188, isEnabled)
	globals.set_boolean(262145 + 28189, isEnabled)
	globals.set_boolean(262145 + 28190, isEnabled)
	globals.set_boolean(262145 + 28191, isEnabled)
	globals.set_boolean(262145 + 28193, isEnabled)
	globals.set_boolean(262145 + 28196, isEnabled)
	globals.set_boolean(262145 + 28201, isEnabled)
	globals.set_boolean(262145 + 28202, isEnabled)
	globals.set_boolean(262145 + 28203, isEnabled)
	globals.set_boolean(262145 + 29589, isEnabled)
	globals.set_boolean(262145 + 29590, isEnabled)
	globals.set_boolean(262145 + 29591, isEnabled)
	globals.set_boolean(262145 + 29592, isEnabled)
	globals.set_boolean(262145 + 29593, isEnabled)
	globals.set_boolean(262145 + 29594, isEnabled)
	globals.set_boolean(262145 + 29595, isEnabled)
	globals.set_boolean(262145 + 29596, isEnabled)
	globals.set_boolean(262145 + 29597, isEnabled)
	globals.set_boolean(262145 + 29598, isEnabled)
	globals.set_boolean(262145 + 29599, isEnabled)
	globals.set_boolean(262145 + 29600, isEnabled)
	globals.set_boolean(262145 + 29601, isEnabled)
	globals.set_boolean(262145 + 29602, isEnabled)
	globals.set_boolean(262145 + 29603, isEnabled)
	globals.set_boolean(262145 + 29604, isEnabled)
	globals.set_boolean(262145 + 29605, isEnabled)
	globals.set_boolean(262145 + 30305, isEnabled)
	globals.set_boolean(262145 + 30306, isEnabled)
	globals.set_boolean(262145 + 30307, isEnabled)
	globals.set_boolean(262145 + 30308, isEnabled)
	globals.set_boolean(262145 + 30309, isEnabled)
	globals.set_boolean(262145 + 30310, isEnabled)
	globals.set_boolean(262145 + 30311, isEnabled)
	globals.set_boolean(262145 + 30312, isEnabled)
	globals.set_boolean(262145 + 30313, isEnabled)
	globals.set_boolean(262145 + 30314, isEnabled)
	globals.set_boolean(262145 + 30315, isEnabled)
	globals.set_boolean(262145 + 30316, isEnabled)
	globals.set_boolean(262145 + 30317, isEnabled)
	globals.set_boolean(262145 + 30318, isEnabled)
	globals.set_boolean(262145 + 30319, isEnabled)
	globals.set_boolean(262145 + 30320, isEnabled)
	globals.set_boolean(262145 + 30321, isEnabled)
	globals.set_boolean(262145 + 31212, isEnabled)
	globals.set_boolean(262145 + 31213, isEnabled)
	globals.set_boolean(262145 + 31214, isEnabled)
	globals.set_boolean(262145 + 31215, isEnabled)
	globals.set_boolean(262145 + 31216, isEnabled)
	globals.set_boolean(262145 + 31217, isEnabled)
	globals.set_boolean(262145 + 31218, isEnabled)
	globals.set_boolean(262145 + 31219, isEnabled)
	globals.set_boolean(262145 + 31220, isEnabled)
	globals.set_boolean(262145 + 31221, isEnabled)
	globals.set_boolean(262145 + 31222, isEnabled)
	globals.set_boolean(262145 + 31223, isEnabled)
	globals.set_boolean(262145 + 31224, isEnabled)
	globals.set_boolean(262145 + 31225, isEnabled)
	globals.set_boolean(262145 + 31226, isEnabled)
	...
	globals.set_boolean(262145 + 34329, isEnabled)
	...
	globals.set_boolean(262145 + 34363, isEnabled)
	...
	globals.set_boolean(262145 + 34385, isEnabled)
	globals.set_boolean(262145 + 34387, isEnabled)
	globals.set_boolean(262145 + 34389, isEnabled)
	globals.set_boolean(262145 + 34391, isEnabled)
	...
	globals.set_boolean(262145 + 34413, isEnabled)
	globals.set_boolean(262145 + 34415, isEnabled)
	globals.set_boolean(262145 + 34417, isEnabled)
	globals.set_boolean(262145 + 34419, isEnabled)
	globals.set_boolean(262145 + 34421, isEnabled)
	...
	globals.set_boolean(262145 + 34491, isEnabled)
	...
	globals.set_boolean(262145 + 34605, isEnabled)
	globals.set_boolean(262145 + 34606, isEnabled)
	globals.set_boolean(262145 + 34607, isEnabled)
	globals.set_boolean(262145 + 34608, isEnabled)
	globals.set_boolean(262145 + 34609, isEnabled)
	globals.set_boolean(262145 + 34610, isEnabled)
	globals.set_boolean(262145 + 34611, isEnabled)
	globals.set_boolean(262145 + 34612, isEnabled)
	globals.set_boolean(262145 + 34613, isEnabled)
	globals.set_boolean(262145 + 34614, isEnabled)
	globals.set_boolean(262145 + 34615, isEnabled)
	globals.set_boolean(262145 + 34616, isEnabled)
	globals.set_boolean(262145 + 34617, isEnabled)
	globals.set_boolean(262145 + 35629, isEnabled)
	globals.set_boolean(262145 + 35630, isEnabled)
	globals.set_boolean(262145 + 35631, isEnabled)
	globals.set_boolean(262145 + 35632, isEnabled)
	globals.set_boolean(262145 + 35633, isEnabled)
	globals.set_boolean(262145 + 35634, isEnabled)
	globals.set_boolean(262145 + 35635, isEnabled)
	globals.set_boolean(262145 + 35636, isEnabled)
	globals.set_boolean(262145 + 35637, isEnabled)
	globals.set_boolean(262145 + 35638, isEnabled)
	globals.set_boolean(262145 + 35639, isEnabled)
	globals.set_boolean(262145 + 35640, isEnabled)
	globals.set_boolean(262145 + 35641, isEnabled)
	globals.set_boolean(262145 + 35642, isEnabled)
	globals.set_boolean(262145 + 35643, isEnabled)
end
...
ColTMenu:add_bare_item("", function()
	return "Action Figures (" .. globals.get_int(2708409 + 209) .. "/100)"
end, function()
	globals.set_int(2708409 + 209, 100)
end, function() end, function() end)
ColTMenu:add_bare_item("", function()
	return "LD Organics (" .. globals.get_int(2708409 + 593) .. "/100)"
end, function()
	globals.set_int(2708409 + 593, 100)
end, function() end, function() end)
ColTMenu:add_bare_item("", function()
	return "Playing Cards (" .. globals.get_int(2708409 + 210) .. "/54)"
end, function()
	globals.set_int(2708409 + 210, 54)
end, function() end, function() end)
ColTMenu:add_bare_item("", function()
	return "Signal Jammers (" .. globals.get_int(2708409 + 211) .. "/50)"
end, function()
	globals.set_int(2708409 + 211, 50)
end, function() end, function() end)
ColTMenu:add_bare_item("", function()
	return "Treasure Chests (" .. globals.get_int(2708409 + 506) .. "/30)"
end, function()
	globals.set_int(2708409 + 506, 30)
end, function() end, function() end)
ColTMenu:add_bare_item("", function()
	return "Snowmen (" .. globals.get_int(2708409 + 600) .. "/25)"
end, function()
	globals.set_int(2708409 + 600, 25)
end, function() end, function() end)
ColTMenu:add_bare_item("", function()
	return "Buried Stashes (" .. globals.get_int(2708409 + 553) .. "/10)"
end, function()
	globals.set_int(2708409 + 553, 10)
end, function() end, function() end)
ColTMenu:add_bare_item("", function()
	return "Hidden Caches (" .. globals.get_int(2708409 + 504) .. "/10)"
end, function()
	globals.set_int(2708409 + 504, 10)
end, function() end, function() end)
ColTMenu:add_bare_item("", function()
	return "Jack o Lantern (" .. globals.get_int(2708409 + 591) .. "/10)"
end, function()
	globals.set_int(2708409 + 591, 10)
end, function() end, function() end)
ColTMenu:add_bare_item("", function()
	return "Movie Props (" .. globals.get_int(2708409 + 494) .. "/10)"
end, function()
	globals.set_int(2708409 + 494, 10)
end, function() end, function() end)
...
ColPMenu:add_bare_item("", function()
	...
	globals.set_int(2708409 + 209, 99)
end, function() end, function() end)
ColPMenu:add_bare_item("", function()
	return "LD Organics (" .. globals.get_int(2708409 + 593) .. "/100)"
end, function()
	globals.set_int(2708409 + 593, 99)
end, function() end, function() end)
ColPMenu:add_bare_item("", function()
	return "Playing Cards (" .. globals.get_int(2708409 + 210) .. "/54)"
end, function()
	globals.set_int(2708409 + 210, 53)
end, function() end, function() end)
ColPMenu:add_bare_item("", function()
	return "Signal Jammers (" .. globals.get_int(2708409 + 211) .. "/50)"
end, function()
	globals.set_int(2708409 + 211, 49)
end, function() end, function() end)
ColPMenu:add_bare_item("", function()
	return "Treasure Chests (" .. globals.get_int(2708409 + 506) .. "/30)"
end, function()
	globals.set_int(2708409 + 506, 29)
end, function() end, function() end)
ColPMenu:add_bare_item("", function()
	return "Snowmen (" .. globals.get_int(2708409 + 600) .. "/25)"
end, function()
	globals.set_int(2708409 + 600, 24)
end, function() end, function() end)
ColPMenu:add_bare_item("", function()
	return "Buried Stashes (" .. globals.get_int(2708409 + 553) .. "/10)"
end, function()
	globals.set_int(2708409 + 553, 9)
end, function() end, function() end)
ColPMenu:add_bare_item("", function()
	return "Hidden Caches (" .. globals.get_int(2708409 + 504) .. "/10)"
end, function()
	globals.set_int(2708409 + 504, 9)
end, function() end, function() end)
ColPMenu:add_bare_item("", function()
	return "Jack o Lantern (" .. globals.get_int(2708409 + 591) .. "/10)"
end, function()
	globals.set_int(2708409 + 591, 9)
end, function() end, function() end)
ColPMenu:add_bare_item("", function()
	return "Movie Props (" .. globals.get_int(2708409 + 494) .. "/10)"
end, function()
	globals.set_int(2708409 + 494, 9)
end, function() end, function() end)
...
FUMenu:add_action("Unlock Skull Tatoo", function()
...
StoryCharacters:add_int_range("Michael's Cash", 10000000, 0, 2147483647, function()
	return stats.get_int("SP0_TOTAL_CASH")
end, function(MicCas)
	stats.set_int("SP0_TOTAL_CASH", MicCas)
end)

StoryCharacters:add_int_range("Franklin's Cash", 10000000, 0, 2147483647, function()
	return stats.get_int("SP1_TOTAL_CASH")
end, function(MicCas)
	stats.set_int("SP1_TOTAL_CASH", MicCas)
end)

StoryCharacters:add_int_range("Trevor's Cash", 10000000, 0, 2147483647, function()
...
AirCargoMenu = UltimateMoneyMethodsMenu:add_submenu("Air Cargo Menu")
...
AirCargoMenu:add_int_range("Set Payout Manual", 1000000, 0, 2147483647, function()
	return globals.get_int(CARGO1)
end, function(value)
	globals.set_int(CARGO1, value)
	globals.set_int(CARGO2, value)
	globals.set_int(CARGO3, value)
	globals.set_int(CARGO4, value)
	globals.set_int(CARGO5, value)
	globals.set_int(CARGO6, value)
	globals.set_int(CARGO7, value)
	globals.set_int(CARGO8, value)
end)

AirCargoMenu:add_array_item(
	"Set Payout Preset",
	{ "1Mil$", "2Mil$", "4Mil$", "8Mil$", "10Mil$", "49Mil$", "100Mil$", "1Bil$", "2Bil$" },
	function()
		return xox_8
	end,
	function(v)
		if v == 1 then
			for i = 22493, 22500 do
				globals.set_int(262145 + i, 1000000)
			end
		elseif v == 2 then
			for i = 22493, 22500 do
				globals.set_int(262145 + i, 2000000)
			end
		elseif v == 3 then
			for i = 22493, 22500 do
				globals.set_int(262145 + i, 4000000)
			end
		elseif v == 4 then
			for i = 22493, 22500 do
				globals.set_int(262145 + i, 8000000)
			end
		elseif v == 5 then
			for i = 22493, 22500 do
				globals.set_int(262145 + i, 10000000)
			end
		elseif v == 6 then
			for i = 22493, 22500 do
				globals.set_int(262145 + i, 49000000)
			end
		elseif v == 7 then
			for i = 22493, 22500 do
				globals.set_int(262145 + i, 100000000)
			end
		elseif v == 8 then
			for i = 22493, 22500 do
				globals.set_int(262145 + i, 1000000000)
			end
		elseif v == 9 then
			for i = 22493, 22500 do
				globals.set_int(262145 + i, 2000000000)
			end
		end
		xox_8 = v
	end
...
AirCargoMenu:add_toggle("Remove Rons's cut", function()
	return ont
end, function()
	ont = not ont
	RCRT(ont)
...
AirCargoMenu:add_action("Instant Finish Sell Mission", function()
	if SMU:is_active() then
		local value = SMU:get_int(1985 + 1078)
		sleep(0.1)
		SMU:set_int(1985 + 1035, value)
	end
end)

AirCargoMenu:add_action("Instant Finish Buy Mission", function()
	if SMU:is_active() then
		SMU:set_int(2022, 5632)
		SMU:set_int(2024, 175427)
	end
end)

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

AirCargoEditorMenu = AirCargoMenu:add_submenu("Air Cargo Data Editor")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

AirCargoEditorMenu:add_action("Reset Crate Sell Stats-0/0 Sales", function()
...
local function NightLoop1()
	...
	while a44 do
		SafeValue = 1845221 + (localplayer:get_player_id() * 889) + 268 + 360 + 6
...
local function funcCeoManager()
	while boolCeoManager do
		...
		if scrSecuroServ:is_active() then
			scrSecuroServ:set_int(759, 1)
			sleep(1)
			scrSecuroServ:set_int(760, 1)
			sleep(1)
			scrSecuroServ:set_int(560, 3012)
		end

		if scrSellContraband:is_active() then
			scrSellContraband:set_int(563 + 584, 1)
			scrSellContraband:set_int(563 + 55, 0)
			scrSellContraband:set_int(563 + 584, 0)
			scrSellContraband:set_int(563 + 7, 7)
			sleep(1)
			scrSellContraband:set_int(563 + 1, 99999)
		end
		sleep(1)
	end
end
...
CratesMenu:add_int_range("Instant Buy", 1, 1, 111, function()
	...
	if GCB:is_active() then
		GCB:set_int(621 + 5, 1)
		GCB:set_int(621 + 1, CV)
		GCB:set_int(621 + 191, 6)
		GCB:set_int(621 + 192, 4)
		GCv2 = CV
	end
end)
...
local m = 1962995 --SERVICE_SPEND_ORBITAL_AUTO
local enable1 = false
local enable2 = false
local enable3 = false
local enable4 = false
...
WM29Menu = EventsMenu:add_submenu("WM29 Event Menu")

WM29Menu:add_action("Enable Event", function()
	if globals.get_int(1882780 + (1 + (localplayer:get_player_id() * 149)) + 82) ~= 1 then
		return
	end
	if globals.get_int(1882379 + 1 + 226) > 1 then
		return
	end
	if not globals.get_bool(2672939 + 4 + 4) then
		return
	end
	if globals.get_int(1882379 + 1 + 226) == 1 then
	...
	local freemodescript = script("freemode")
	freemodescript:set_int(15827 + 181 + 1 + 1, 0x75F9)
end)

WM29Menu:add_action("Teleport", function()
	teleport_myself(-889.3795166015625, -447.8448181152344, 171.81410217285156)
end)
...
halloweatherMenu = EventsMenu:add_submenu("Halloween Weather Toggle Menu")
...
halloweatherMenu:add_toggle("Toggle Halloween Weather", function()
