...
Self:add_array_item("Online Session", {
	...
	elseif value == 3 then
		...
		globals.set_int(1574589, 0)
	elseif value == 4 then
		globals.set_int(1575020, 2)
		globals.set_int(1574589, 1)
		sleep(0.2)
		globals.set_int(1574589, 0)
	elseif value == 5 then
		globals.set_int(1575020, 3)
		globals.set_int(1574589, 1)
		sleep(0.2)
		globals.set_int(1574589, 0)
	elseif value == 6 then
		globals.set_int(1575020, 6)
		globals.set_int(1574589, 1)
		sleep(0.2)
		globals.set_int(1574589, 0)
	elseif value == 7 then
		globals.set_int(1575020, 9)
		globals.set_int(1574589, 1)
		sleep(0.2)
		globals.set_int(1574589, 0)
	elseif value == 8 then
...
RMenu:add_action("Unlock Diamond Casino Heist Outfits", function()
...
normalstat:add_int_range("Earned Money", 500000, 0, 1000000000, function()
	return stats.get_int("MPPLY_TOTAL_EVC")
end, function(value)
	stats.set_int("MPPLY_TOTAL_EVC", value)
end)
normalstat:add_int_range("Spent Money", 500000, 0, 1000000000, function()
...
TunMenu:add_float_range("RP", 1, 1, 100000, function()
	return globals.get_float(262145 + 1)
end, function(v)
	globals.set_float(262145 + 1, v)
end)

TunMenu:add_float_range("AP", 1, 1, 100000, function()
	return globals.get_float(288259)
end, function(v)
	globals.set_float(288259, v)
end)

TunMenu:add_float_range("Street Races", 1, 1, 100000, function()
	return globals.get_float(294000)
end, function(v)
	globals.set_float(294000, v)
end)

TunMenu:add_float_range("Pursuits", 1, 1, 100000, function()
	return globals.get_float(294001)
end, function(v)
	globals.set_float(294001, v)
end)

TunMenu:add_float_range("Face2Face", 1, 1, 100000, function()
	return globals.get_float(294003)
end, function(v)
	globals.set_float(294003, v)
end)

TunMenu:add_float_range("LS Car Meet", 1, 1, 100000, function()
	return globals.get_float(294005)
end, function(v)
	globals.set_float(294005, v)
end)

TunMenu:add_float_range("LS Car Meet on track", 1, 1, 100000, function()
	return globals.get_float(294006)
end, function(v)
	globals.set_float(294006, v)
end)
...
local function AgencyMaxPayout(Enabled)
	...
	if Enabled then
		globals.set_int(262145 + 32351, 2500000)
	else
		globals.set_int(262145 + 32351, 1000000)
	end
end
...
L7NEGCONTRACTS:add_action("Cooldown Killer", function()
	globals.set_int(262145 + 32385, 0)
end)
...
L7NEGAPCUT:add_int_range("Apt Player 1", 1.0, 15, 100, function()
	return globals.get_int(1938365 + 3008 + 1)
end, function(value)
	globals.set_int(1938365 + 3008 + 1, value)
end)
L7NEGAPCUT:add_int_range("Apt Player 2", 1.0, 15, 100, function()
	return globals.get_int(1938365 + 3008 + 1 + 1)
end, function(value)
	globals.set_int(1938365 + 3008 + 1 + 1, value)
end)
L7NEGAPCUT:add_int_range("Apt Player 3", 1.0, 15, 100, function()
	return globals.get_int(1938365 + 3008 + 1 + 1 + 1)
end, function(value)
	globals.set_int(1938365 + 3008 + 1 + 1 + 1, value)
end)
L7NEGAPCUT:add_int_range("Apt Player 4", 1.0, 15, 100, function()
	return globals.get_int(1938365 + 3008 + 1 + 1 + 1 + 1)
end, function(value)
	globals.set_int(1938365 + 3008 + 1 + 1 + 1 + 1, value)
end)

L7NEGAPCUT:add_action("All 100", function()
	for i = 1938365 + 3008 + 1, 1938365 + 3008 + 1 + 1 + 1 + 1 do
...
L7NEGCASINO:add_int_range("Casino Lifes - Self", 1, 1, 999999999, function()
	return FMC:get_int(26136 + 1325 + 1)
end, function(life)
	if FMC and FMC:is_active() then
		FMC:set_int(26136 + 1325 + 1, life)
	end
end)
...
L7NEGCAYO:add_action("Instant Finish $$", function()
	FMC2020:set_int(45450, 9)
	FMC2020:set_int(46829, 50)
end)
...
L7NEGCAYO:add_action("Skip Drainage cut", function()
	if FMC2020:is_active() then
		if FMC2020:get_int(28446) >= 4 or FMC2020:get_int(28446) <= 6 then
			FMC2020:set_int(28446, 6)
		end
	end
end)
...
L7NEGCAYO:add_action("Bypass Fingerprint Scanner", function()
	if FMC2020 and FMC2020:is_active() then
		if FMC2020:get_int(23669) == 4 then
			FMC2020:set_int(23669, 5)
		end
	end
end)

L7NEGCAYO:add_action("Skip Plasma Cutter", function()
	FMC2020:set_float(29685 + 3, 100.0)
end)
...
cutsMenu:add_array_item(
	...
	function(G)
		if G == 1 then
			for i = 1978495 + 881 + 1, 1978495 + 881 + 1 + 1 + 1 + 1 do
...
cutsMenu:add_int_range("Player 1", 1, 15, 300, function()
	return globals.get_int(1978495 + 881 + 1)
end, function(value)
	globals.set_int(1978495 + 881 + 1, value)
end)
cutsMenu:add_int_range("Player 2", 1, 15, 300, function()
	return globals.get_int(1978495 + 881 + 1 + 1)
end, function(value)
	globals.set_int(1978495 + 881 + 1 + 1, value)
end)
cutsMenu:add_int_range("Player 3", 1, 15, 300, function()
	return globals.get_int(1978495 + 881 + 1 + 1 + 1)
end, function(value)
	globals.set_int(1978495 + 881 + 1 + 1 + 1, value)
end)
cutsMenu:add_int_range("Player 4", 1, 15, 300, function()
	return globals.get_int(1978495 + 881 + 1 + 1 + 1 + 1)
end, function(value)
	globals.set_int(1978495 + 881 + 1 + 1 + 1 + 1, value)
end)
...
L7NEG3:add_toggle("Enable Deleted Vehicles", function()
	return globals.get_boolean(262145 + 35167)
end, function(value)
	for a = DV1, DV2 do
	...
	for g = DV15, DV16 do
		globals.set_boolean(g, value)
	end
	for h = DV17, DV18 do
		globals.set_boolean(h, value)
	end
	for i = DV19, DV20 do
	...
	for m = DV27, DV28 do
		globals.set_boolean(m, value)
	end
	for n = DV29, DV30 do
		globals.set_boolean(n, value)
	end
	for o = DV31, DV32 do
		globals.set_boolean(o, value)
	end
	for p = DV33, DV34 do
		globals.set_boolean(p, value)
	end
	for q = 1, #spenz do
		globals.set_boolean(spenz[q], value)
	end
	for r = DV35, DV36 do
		globals.set_boolean(r, value)
	end
	for s = DV37, DV38 do
		globals.set_boolean(s, value)
	end
	for t = DV39, DV40 do
		globals.set_boolean(t, value)
	end
	for u = DV41, DV42 do
		globals.set_boolean(u, value)
	end
	for v = DV43, DV44 do
		globals.set_boolean(v, value)
	end
	globals.set_boolean(DV13, value)
	globals.set_boolean(DV14, value)
end)

L7NEG3:add_action("Unlock baseball And knife Skins In GunVan", function()
...
CharMenu:add_int_range("Stamina", 1, 0, 100, function()
	return stats.get_int(MPX .. "STAMINA")
end, function(Stam)
	stats.set_int(MPX .. "SCRIPT_INCREASE_STAM", 0)
	sleep(5)
	stats.set_int(MPX .. "SCRIPT_INCREASE_STAM", Stam - stats.get_int(MPX .. "STAMINA"))
end)
CharMenu:add_int_range("Shooting", 1, 0, 100, function()
	return stats.get_int(MPX .. "SHOOTING_ABILITY")
end, function(Sho)
	stats.set_int(MPX .. "SCRIPT_INCREASE_SHO", 0)
	sleep(5)
	stats.set_int(MPX .. "SCRIPT_INCREASE_SHO", Sho - stats.get_int(MPX .. "SHOOTING_ABILITY"))
end)
CharMenu:add_int_range("Strength", 1, 0, 100, function()
	return stats.get_int(MPX .. "STRENGTH")
end, function(Strn)
	stats.set_int(MPX .. "SCRIPT_INCREASE_STRN", 0)
	sleep(5)
	stats.set_int(MPX .. "SCRIPT_INCREASE_STRN", Strn - stats.get_int(MPX .. "STRENGTH"))
end)
CharMenu:add_int_range("Stealth", 1, 0, 100, function()
	return stats.get_int(MPX .. "STEALTH_ABILITY")
end, function(Stl)
	stats.set_int(MPX .. "SCRIPT_INCREASE_STL", 0)
	sleep(5)
	stats.set_int(MPX .. "SCRIPT_INCREASE_STL", Stl - stats.get_int(MPX .. "STEALTH_ABILITY"))
end)
CharMenu:add_int_range("Flying", 1, 0, 100, function()
	return stats.get_int(MPX .. "FLYING_ABILITY")
end, function(Fly)
	stats.set_int(MPX .. "SCRIPT_INCREASE_FLY", 0)
	sleep(5)
	stats.set_int(MPX .. "SCRIPT_INCREASE_FLY", Fly - stats.get_int(MPX .. "FLYING_ABILITY"))
end)
CharMenu:add_int_range("Driving", 1, 0, 100, function()
	return stats.get_int(MPX .. "WHEELIE_ABILITY")
end, function(Driv)
	stats.set_int(MPX .. "SCRIPT_INCREASE_DRIV", 0)
	sleep(5)
	stats.set_int(MPX .. "SCRIPT_INCREASE_DRIV", Driv - stats.get_int(MPX .. "WHEELIE_ABILITY"))
end)
CharMenu:add_int_range("Swimming", 1, 0, 100, function()
	return stats.get_int(MPX .. "LUNG_CAPACITY")
end, function(Lung)
	stats.set_int(MPX .. "SCRIPT_INCREASE_LUNG", 0)
	sleep(5)
	stats.set_int(MPX .. "SCRIPT_INCREASE_LUNG", stats.get_int(MPX .. "LUNG_CAPACITY"))
end)
CharMenu:add_float_range("Mental State", 1, 0, 100, function()
	return stats.get_float(MPX .. "PLAYER_MENTAL_STATE")
end, function(Ment)
	stats.set_float(MPX .. "PLAYER_MENTAL_STATE", Ment)
end)
...
L7NEG6:add_action("Unlock All Rep Lvl 1000", function()
	for i = 262145 + 31835, 262145 + 31862 do
