...
L7NEG:add_int_range("Your level", 1, 0, 8000, function() 
	return globals.get_int(1854200 + localplayer:get_player_id() * 867)
end, function() end)

L7NEG:add_int_range("Your RP Value", 1, 0, 1787576850, function() 
	return globals.get_int(1854195 + localplayer:get_player_id() * 867)
end, function() end)

L7NEG:add_int_range("Current Crew Level", 0, 1, 8000, function() return stats.get_int("MPPLY_CURRENT_CREW_RANK") end, function(value)
end)
...
Uv0 = false
		local function SexChanger(On)
			if On then stats.set_int(MPX .. "ALLOW_GENDER_CHANGE", 52)
...
Self:add_action("Empty Session", function() menu.empty_session() end)
...
Self:add_action("Equip Ballastic Equipment Directly", function() globals.set_int(REQS1 + 902, 1) end)
...
Config.TrickOrTreatBase = 2639889
...
local function BuildListSub() 
	L7NEGPL:add_bare_item("---Player List "..GetPlayerCount().." Players---", function() was_opened = true return "---Player List, "..GetPlayerCount().." Players---" end, null, null, null)
			...
			subtroll:add_action("Explode Player (Cars Rush)", function() ExplodePlayer(player.get_player_ped(selectedplayer)) end)	
...
--Rank--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	Rank = RMenu:add_submenu("Set Rank Menu")
	...
	Rank:add_bare_item("", 
		function()
			...
			CurrentRP = globals.get_int(1854195 + localplayer:get_player_id() * 867)
			CurrentRank = 0
			for i = 1, 8000 do 
...
VehiclesM:add_array_item(
	"Request Services",
	{ "M.O.C", "Avenger", "TerrorByte", "Kosatka", "Dinghy", "Acid Lab", "Acid Lab Bike", "Ballastic Equipment", "Ammo Drop" },
	function()
		return xox_01
	end,
	function(v)
...
function handle_thermal_v1()
	if not localplayer:is_in_vehicle() and not menu.get_thermalvision() and localplayer:get_config_flag(PED_FLAG_IS_AIMING) then
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	L7NEGCONTRACTS:add_array_item("VIP Contract", AgencyContracts, function() return a1 end, 
	...
	L7NEGCONTRACTS:add_action("Complete Preps", function() stats.set_int(MPX .. "FIXER_GENERAL_BS", -1) 
												   stats.set_int(MPX .. "FIXER_COMPLETED_BS", -1) 
		...
		local function AgencyMaxPayout(Enabled) 
			...
			if Enabled then globals.set_int(262145 + 32351, 2500000) 
			else globals.set_int(262145 + 32351, 1000000) 
			end 
		end
	L7NEGCONTRACTS:add_toggle("Max Payout (after start)", function() return a2 end, function() a2 = not a2 AgencyMaxPayout(a2) end)
	
	L7NEGCONTRACTS:add_action("Cooldown Killer", function() globals.set_int(262145 + 32385, 0) end)
...
AModdedCutsSelfMenu = L7NEGAPARTMENT:add_submenu("Modded Cuts Menu (Self only)")

AModdedCutsSelfMenu:add_array_item("Fleeca Heist", { "5 Mil", "10 Mil", "15 Mil" }, function()
	return xox_24
end, function(value)
	if value == 1 then
		globals.set_int(1938365 + 3008 + 1, 1987)
	elseif value == 2 then
		globals.set_int(1938365 + 3008 + 1, 3974)
	elseif value == 3 then
		globals.set_int(1938365 + 3008 + 1, 5962)
	end
	xox_24 = value
end)

AModdedCutsSelfMenu:add_array_item("Prison Break Heist", { "5 Mil", "10 Mil", "15 Mil" }, function()
	return xox_27
end, function(value)
	if value == 1 then
		globals.set_int(1938365 + 3008 + 1, 572)
	elseif value == 2 then
		globals.set_int(1938365 + 3008 + 1, 1143)
	elseif value == 3 then
		globals.set_int(1938365 + 3008 + 1, 1714)
	end
	xox_27 = value
end)

AModdedCutsSelfMenu:add_array_item("Humane Labs Raid Heist", { "5 Mil", "10 Mil", "15 Mil" }, function()
	return xox_28
end, function(value)
	if value == 1 then
		globals.set_int(1938365 + 3008 + 1, 424)
	elseif value == 2 then
		globals.set_int(1938365 + 3008 + 1, 847)
	elseif value == 3 then
		globals.set_int(1938365 + 3008 + 1, 1269)
	end
	xox_28 = value
end)

AModdedCutsSelfMenu:add_array_item("Series A Funding Heist", { "5 Mil", "10 Mil", "15 Mil" }, function()
	return xox_29
end, function(value)
	if value == 1 then
		globals.set_int(1938365 + 3008 + 1, 556)
	elseif value == 2 then
		globals.set_int(1938365 + 3008 + 1, 1132)
	elseif value == 3 then
		globals.set_int(1938365 + 3008 + 1, 1697)
	end
	xox_29 = value
end)

AModdedCutsSelfMenu:add_array_item("The Pacific Standard Heist", { "5 Mil", "10 Mil", "15 Mil" }, function()
	return xox_30
end, function(value)
	if value == 1 then
		globals.set_int(1938365 + 3008 + 1, 267)
	elseif value == 2 then
		globals.set_int(1938365 + 3008 + 1, 534)
	elseif value == 3 then
		globals.set_int(1938365 + 3008 + 1, 800)
	end
	xox_30 = value
end)
...
AModdedCutsMenu = L7NEGAPARTMENT:add_submenu("Modded Cuts Normal Mode Menu (All Players)")

AModdedCutsMenu:add_array_item("Fleeca Heist", { "15 Mil" }, function()
	return xox_24
end, function(value)
	if value == 1 then
...
AModdedCutsMenu:add_array_item("Prison Break Heist", { "15 Mil" }, function()
	return xox_27
end, function(value)
	if value == 1 then
 globals.set_int(19364397 + 1 + 1, 100 - (2142 * 4))
 globals.set_int(19364397 + 1 + 1 + 1, 2142)
 globals.set_int(19364397 + 1 + 1 + 1 + 1, 2142)
 globals.set_int(19364397 + 1 + 1 + 1 + 1 + 1, 2142)
 globals.set_int(1938365 + 3008 + 1, 2142)
	end
	xox_27 = value
end)

AModdedCutsMenu:add_array_item("Humane Labs Raid Heist", { "15 Mil" }, function()
	return xox_28
end, function(value)
	if value == 1 then
 globals.set_int(1938365 + 3008 + 1, 1587)
 globals.set_int(19364397 + 1 + 1, 100 - (1587 * 4))
 globals.set_int(19364397 + 1 + 1 + 1, 1587)
 globals.set_int(19364397 + 1 + 1 + 1 + 1, 1587)
 globals.set_int(19364397 + 1 + 1 + 1 + 1 + 1, 1587)
	end
	xox_28 = value
end)

AModdedCutsMenu:add_array_item("Series A Funding Heist", { "15 Mil" }, function()
	return xox_29
end, function(value)
	if value == 1 then
 globals.set_int(1938365 + 3008 + 1, 2121)
 globals.set_int(19364397 + 1 + 1, 100 - (2121 * 4))
 globals.set_int(19364397 + 1 + 1 + 1, 2121)
 globals.set_int(19364397 + 1 + 1 + 1 + 1, 2121)
 globals.set_int(19364397 + 1 + 1 + 1 + 1 + 1, 2121)
	end
	xox_29 = value
end)

AModdedCutsMenu:add_array_item("The Pacific Standard Heist", { "15 Mil" }, function()
	return xox_30
end, function(value)
	if value == 1 then
 globals.set_int(1938365 + 3008 + 1, 1000)
 globals.set_int(19364397 + 1 + 1, 100 - (1000 * 4))
 globals.set_int(19364397 + 1 + 1 + 1, 1000)
 globals.set_int(19364397 + 1 + 1 + 1 + 1, 1000)
 globals.set_int(19364397 + 1 + 1 + 1 + 1 + 1, 1000)
	end
	xox_30 = value
end)

AModdedCutsMenu:add_action("", function() end)

AC15MilNote = AModdedCutsMenu:add_submenu("Read Me")
	
AC15MilNote:add_action("            Activate within 1st 30 secs", function() end)
AC15MilNote:add_action("            after the cutsene ends", function() end)
AC15MilNote:add_action("            (on cuts screen)", function() end)
...
L7NEGCASINO:add_int_range("Casino Lifes - Self", 1, 1, 999999999, function() return fmC:get_int(26136 + 1325 + 1) end, function(life) if fmC and fmC:is_active() then fmC:set_int(26136 + 1325 + 1,life) end end)

local function Cctv(e) if not localplayer then return end if e then menu.remove_cctvs() else menu.remove_cctvs(nil) end end
L7NEGCASINO:add_toggle("Remove CCTV", function() return e6 end, function() e6 = not e6 Cctv(e6) end) 
...
L7NEGCAYO:add_array_item('Presets (Easy Mode)',
    {"N.Panther Only", "N.PinkD Only", "N.B.Bonds Only", "N.R.Necklace Only", "N.Tequila Only"}, function()
        return 1
    end, function(v)
        if v == 1 then
...
L7NEGCAYO:add_array_item('Presets (Hard Mode)',
    {"H.Panther Only", "H.PinkD Only", "H.Bonds Only", "H.Necklace Only", "H.Tequila Only"}, function()
        return 1
    end, function(Value)
        if Value == 1 then
            -- PANTHER
...
setupcayo:add_array_item("Primary Target",
    {"Tequila", "Ruby Necklace", "Bearer Bonds", "Pink Diamond", "Panther Statue"}, function()
        return 1
    end, function(value)
        if value == 1
        then
...
setupcayo:add_array_item("Sec Loot (All Compound)", {"Gold", "Paintings", "Cocaine", "Weed", "Cash"},
    function()
        return 1
    end, function(value)
        if value == 1 then
...
L7NEGDOOMSDAY:add_action("Instant Finish $$", function()
 ...
 fmC:set_int(19710 + 2686, 10000000)
...
ddCMenu:add_action("                      ~Manual Cuts ", function()
 end) 
...
return globals.get_boolean(262145 + 35167) end, function(value)
for a = DV1, DV2 
do 
globals.set_boolean(a,value) end 
for b = DV3, DV4 
do 
...
for d = DV7, DV8 
do 
globals.set_boolean(d,value) end  
for e = DV9, DV10
do
globals.set_boolean(e,value) end
for f = DV11, DV12
do
globals.set_boolean(f,value) end
for g = DV15, DV16
do
globals.set_boolean(g,value) end
for h = DV17, DV18
do
globals.set_boolean(h,value) end
for i = DV19, DV20
do
...
for o = DV31, DV32
do
globals.set_boolean(o,value) end
for p = DV33, DV34
do
globals.set_boolean(p,value) end
for q = 1, #spenz do
globals.set_boolean(spenz[q],value) end
for r = DV35, DV36
do
globals.set_boolean(r,value) end
for s = DV37, DV38
do
globals.set_boolean(s,value) end
for t = DV39, DV40
do
globals.set_boolean(t,value) end
for u = DV41, DV42
do
globals.set_boolean(u,value) end
for v = DV43, DV44
do
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	ColTMenu:add_bare_item("", function() return "Action Figures (" .. globals.get_int(2765084 + 209) .. "/100)" end, function() globals.set_int(2765084 + 209, 100) end, function() end, function() end)
	ColTMenu:add_bare_item("", function() return "LD Organics (" .. globals.get_int(2765084 + 593) .. "/100)" end, function() globals.set_int(2765084 + 593, 100) end, function() end, function() end)
	ColTMenu:add_bare_item("", function() return "Playing Cards (" .. globals.get_int(2765084 + 210) .. "/54)" end, function() globals.set_int(2765084 + 210, 54) end, function() end, function() end)
	ColTMenu:add_bare_item("", function() return "Signal Jammers (" .. globals.get_int(2765084 + 211) .. "/50)" end, function() globals.set_int(2765084 + 211, 50) end, function() end, function() end)
	ColTMenu:add_bare_item("", function() return "Treasure Chests (" .. globals.get_int(2765084 + 506) .. "/30)" end, function() globals.set_int(2765084 + 506, 30) end, function() end, function() end)
	ColTMenu:add_bare_item("", function() return "Snowmen (" .. globals.get_int(2765084 + 600) .. "/25)" end, function() globals.set_int(2765084 + 600, 25) end, function() end, function() end)
	ColTMenu:add_bare_item("", function() return "Buried Stashes (" .. globals.get_int(2765084 + 553) .. "/10)" end, function() globals.set_int(2765084 + 553, 10) end, function() end, function() end)
	ColTMenu:add_bare_item("", function() return "Hidden Caches (" .. globals.get_int(2765084 + 504) .. "/10)" end, function() globals.set_int(2765084 + 504, 10) end, function() end, function() end)
	ColTMenu:add_bare_item("", function() return "Jack o Lantern (" .. globals.get_int(2765084 + 591) .. "/10)" end, function() globals.set_int(2765084 + 591, 10) end, function() end, function() end)
	ColTMenu:add_bare_item("", function() return "Movie Props (" .. globals.get_int(2765084 + 494) .. "/10)" end, function() globals.set_int(2765084 + 494, 10) end, function() end, function() end)
	
	ColPMenu = ColMenu:add_submenu("Unlock All (Permanently)")
	
	ColPMenu:add_bare_item("", function() return "Action Figures (" .. globals.get_int(2765084 + 209) .. "/100)" end, function() globals.set_int(2765084 + 209, 99) end, function() end, function() end)
	ColPMenu:add_bare_item("", function() return "LD Organics (" .. globals.get_int(2765084 + 593) .. "/100)" end, function() globals.set_int(2765084 + 593, 99) end, function() end, function() end)
	ColPMenu:add_bare_item("", function() return "Playing Cards (" .. globals.get_int(2765084 + 210) .. "/54)" end, function() globals.set_int(2765084 + 210, 53) end, function() end, function() end)
	ColPMenu:add_bare_item("", function() return "Signal Jammers (" .. globals.get_int(2765084 + 211) .. "/50)" end, function() globals.set_int(2765084 + 211, 49) end, function() end, function() end)
	ColPMenu:add_bare_item("", function() return "Treasure Chests (" .. globals.get_int(2765084 + 506) .. "/30)" end, function() globals.set_int(2765084 + 506, 29) end, function() end, function() end)
	ColPMenu:add_bare_item("", function() return "Snowmen (" .. globals.get_int(2765084 + 600) .. "/25)" end, function() globals.set_int(2765084 + 600, 24) end, function() end, function() end)
	ColPMenu:add_bare_item("", function() return "Buried Stashes (" .. globals.get_int(2765084 + 553) .. "/10)" end, function() globals.set_int(2765084 + 553, 9) end, function() end, function() end)
	ColPMenu:add_bare_item("", function() return "Hidden Caches (" .. globals.get_int(2765084 + 504) .. "/10)" end, function() globals.set_int(2765084 + 504, 9) end, function() end, function() end)
	ColPMenu:add_bare_item("", function() return "Jack o Lantern (" .. globals.get_int(2765084 + 591) .. "/10)" end, function() globals.set_int(2765084 + 591, 9) end, function() end, function() end)
	ColPMenu:add_bare_item("", function() return "Movie Props (" .. globals.get_int(2765084 + 494) .. "/10)" end, function() globals.set_int(2765084 + 494, 9) end, function() end, function() end)
...
FUMenu:add_action("Unlock Hidden Cars Skins", function() stats.set_int("MPPLY_XMASLIVERIES", -1) for i = 1, 20 do stats.set_int("MPPLY_XMASLIVERIES"..i, -1) end end)

FUMenu:add_action("Unlock All Flight School", function() stats.set_int("MPPLY_NUM_CAPTURES_CREATED", 100) for i = 0, 9 do stats.set_int("MPPLY_PILOT_SCHOOL_MEDAL_"..i, -1) stats.set_int(MPX .. "PILOT_SCHOOL_MEDAL_"..i, -1) stats.set_bool(MPX .. "PILOT_ASPASSEDLESSON_"..i, true) end end)

FUMenu:add_action("Unlock All Bunker Shooting Range", function() stats.set_int(MPX .. "SR_HIGHSCORE_1", 690) stats.set_int(MPX .. "SR_HIGHSCORE_2", 1860) stats.set_int(MPX .. "SR_HIGHSCORE_3", 2690) stats.set_int(MPX .. "SR_HIGHSCORE_4", 2660) stats.set_int(MPX .. "SR_HIGHSCORE_5", 2650) stats.set_int(MPX .. "SR_HIGHSCORE_6", 450) stats.set_int(MPX .. "SR_TARGETS_HIT", 269) stats.set_int(MPX .. "SR_WEAPON_BIT_SET", -1) stats.set_bool(MPX .. "SR_TIER_1_REWARD", true) stats.set_bool(MPX .. "SR_TIER_3_REWARD", true) stats.set_bool(MPX .. "SR_INCREASE_THROW_CAP", true) end)
...
FUMenu:add_action("Unlock All Tattos", function() stats.set_int(MPX .. "TATTOO_FM_CURRENT_32", -1) for i = 0, 47 do stats.set_int(MPX .. "TATTOO_FM_UNLOCKS_"..i, -1) end end)
...
local L7NEGDRGWR={"Designated Driver","FatalIncursion","Uncontrolled Substance","Make War not Love","Off the Rails","This is an Intervention","Unusual Suspects","FriedMind","Checking In","BDKD"}
...
--Story Characters Money Editor By Silent---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	StoryCharacters:add_int_range("Michael's Cash", 10000000, 0, 2147483646, function() return stats.get_int("SP0_TOTAL_CASH") end,
		function(MicCas) stats.set_int("SP0_TOTAL_CASH", MicCas) end)
		
	StoryCharacters:add_int_range("Franklin's Cash", 10000000, 0, 2147483646, function() return stats.get_int("SP1_TOTAL_CASH") end,
		function(MicCas) stats.set_int("SP1_TOTAL_CASH", MicCas) end)

	StoryCharacters:add_int_range("Trevor's Cash", 10000000, 0, 2147483646, function() return stats.get_int("SP2_TOTAL_CASH") end,
...
L7NEGMW29:add_action("Enable Event", function()
...
L7NEGMW29:add_action("Enable the Event V2 (By ShinyWasabi)", function() 
    ...
    sleep(1)
    globals.set_int(262145 + 34313, 1) -- Tunable: ENABLE_MAZEBANKSHOOTOUT_DLC22022
    globals.set_int(262145 + 34036, 1000) -- This is the cooldown (default 1200000ms) - Tunable: 1839585304
end)
...
L7NEGMW29README:add_action("Then Active Enable Event", function() end)

L7NEGMW29README:add_action("Then Stand AFK And Waiting For 20m", function() end)

L7NEGMW29README:add_action("After That, From 20:00 PM To", function() end)

L7NEGMW29README:add_action("06:00 AM, Wait", function() end)
...
L7NEGARTM = L7NEGEVENTS:add_submenu("Armoured Trucks Menu")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

L7NEGARTM:add_action("Enable Event For Invite Only Session", function()
    globals.set_int(262145 + 35055, 1) -- Tunable: -863123713 - enable the event Credit to PLTytus.
    globals.set_int(262145 + 34038, 1000) -- Cooldown (default 1200000ms)
end)
...
L7NEGARTM:add_action("Teleport NO1", function()
	 teleport_myself(1167.3674, 2685.9873, 37.0223)
 end)

L7NEGARTM:add_action("Teleport NO2", function()
	 teleport_myself(-104.8438, 6442.3013, 30.2902)
 end)

L7NEGARTM:add_action("Teleport NO3", function()
	 teleport_myself(-3120.3572, 1098.8795, 19.4724)
 end)

L7NEGARTM:add_action("Teleport NO4", function()
	 teleport_myself(1691.0608, 4954.909, 41.9807)
 end)

L7NEGARTM:add_action("Teleport NO5", function()
	 teleport_myself(879.904, 40.0896, 77.5421)
 end)

L7NEGARTM:add_action("Teleport NO6", function()
	 teleport_myself(-800.4483, -2500.8657, 12.7161)
 end)

L7NEGARTM:add_action("Teleport NO7", function()
	 teleport_myself(32.7233, -737.406, 43.1938)
 end)

L7NEGARTM:add_action("Teleport NO8", function()
	 teleport_myself(1182.274, -1428.4326, 33.9032)
 end)

L7NEGARTM:add_action("Teleport NO9", function()
	 teleport_myself(-291.5711, -39.9482, 48.0075)
 end)


L7NEGARTM:add_action("Teleport NO10", function()
	 teleport_myself(-1355.0416, -439.8646, 33.8337)
 end)
...
L7NEG6:add_action("Unlock All Rep Lvl 1000", function() for i = 262145 + 31835, 262145 + 31862 do globals.set_float(i, 100000) end end)
...
L7NEG5:add_action("Skip Yacht Misions", function() 
...
L7NEG1:add_action("---Discord:@offlinemods---", function() end)
