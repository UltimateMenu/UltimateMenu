...
L7NEGMONEYREMOVER:add_int_range("Set Casino Chips Buy Limit", 1000000, 0, 2147483647, function()
	return globals.get_int(289313)
end, function(value)
	globals.set_int(289313, value)
end)
...
Peyote:add_action("Enable Event", function()
	globals.set_int(262145 + 28080, 1)
end)
...
Snowman:add_action("Enable Event", function()
	globals.set_int(262145 + 34049, 1)
end)
...
Slipping = L7NEGT:add_submenu("Still Slipping Menu")
Slipping:add_action("Enable Event", function()
	globals.set_int(262145 + 30175, 1)
	globals.set_int(262145 + 30176, 0)
end)
Slipping:add_array_item("Location No.", { "01", "02", "03", "04", "05", "06", "07", "08", "09", "10" }, function()
	return location_0
end, function(location_1)
	if location_1 == 1 then
		localplayer:set_position(vector3(-369.873322, 6107.025879, 38.17276))
	elseif location_1 == 2 then
		localplayer:set_position(vector3(442.673492, 5561.108887, 780.9000))
	elseif location_1 == 3 then
		localplayer:set_position(vector3(2676.284180, 4573.231934, 39.300000))
	elseif location_1 == 4 then
		localplayer:set_position(vector3(1943.071533, 3796.729980, 30.740000))
	elseif location_1 == 5 then
		localplayer:set_position(vector3(717.495789, 2584.313232, 72.05000))
	elseif location_1 == 6 then
		localplayer:set_position(vector3(770.636475, 1274.550537, 359.000000))
	elseif location_1 == 7 then
		localplayer:set_position(vector3(-2212.988770, 339.175201, 197.800000))
	elseif location_1 == 8 then
		localplayer:set_position(vector3(-1186.412231, -1553.260254, 20.076726))
	elseif location_1 == 9 then
		localplayer:set_position(vector3(-148.416458, -122.707596, 95.860000))
	elseif location_1 == 10 then
		localplayer:set_position(vector3(840.573669, -2295.953125, 52.373225))
	end
	location_0 = location_1
end)
Lantern = L7NEGT:add_submenu("Jack o'Lantern Menu")
Lantern:add_action("Enable Event", function()
	globals.set_int(262145 + 32978, 1)
end)
...
MoneyDrop:add_action("Start Money Drop", PedDrop)
...
local halloweatherAddress = 262145 + 33051
local isEnabled = false
