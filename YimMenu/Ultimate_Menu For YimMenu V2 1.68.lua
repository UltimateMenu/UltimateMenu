...
L7NEG:add_text("Ultimate Menu 1.68 [V2]")
...
L7NEG3:add_button("Unlock 1.68 New Vehicles", function()
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
MOHA = L7NEG7:add_tab("Drop Menu By MOHA")

Me = MOHA:add_tab("Drop 1.68 (Detected / Risky)")
...
Me:add_text(" ")
Me:add_text("Drop Menu v1.0 by MOHA for YimMenu.")
Me:add_text(" ")
Me:add_text("NOTE: Some people may not receive the Money and RP")
Me:add_text("because they have protections.")
Me:add_text("NOTE: If a player receives too many figures,")
...
Me:add_text("NOTE: If you give too much to one or more players,")
Me:add_text("after a while they may get a black transaction error screen.")
Me:add_text("NOTE: Don't be a spectator of a player when you drop.")
Me:add_text("You must be present!")
Me:add_text("NOTE: Don't stop the world time!")
Me:add_text(" ")
...
MOHAandgir489 = L7NEG1:add_tab("MOHA & gir489returns")
MOHAandgir489:add_text("For Drop Menu")

ShineyWassabi = L7NEG1:add_tab("ShineyWassabi & gir489returns")
